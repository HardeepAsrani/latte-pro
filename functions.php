...
require_once( trailingslashit( get_template_directory() ) . '/inc/widgets/latte-pricing.php' );
require_once( trailingslashit( get_template_directory() ) . '/inc/widgets/latte-testimonials.php' );
require_once( trailingslashit( get_template_directory() ) . '/inc/other/portfolio.php' );
...
function latte_scripts() {
	...
	if( isset($latte_animations_display) && $latte_animations_display != 1 ) if( is_page_template( 'template-home.php' ) ) wp_enqueue_script( 'latte_scrollreveal', get_template_directory_uri() . '/assets/js/scrollReveal.min.js', array( 'jquery' ),'',true);
	...
	wp_localize_script( 'latte_scripts_js', 'latte_script_var', array(
		...
		'latte_portfolio_display' => get_theme_mod('latte_portfolio_display'),
		'latte_subscribe_display' => get_theme_mod('latte_subscribe_display'),
		...
		'latte_contact_display' => get_theme_mod('latte_contact_display')
	));
}
