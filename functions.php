...
function latte_scripts() {
	...
	if( isset($latte_animations_display) && $latte_animations_display != 1 ) if( is_page_template( 'template-home.php' ) ) wp_enqueue_script( 'latte_scrollreveal', get_stylesheet_directory_uri() . '/assets/js/scrollReveal.min.js', array( 'jquery' ),'',true);
