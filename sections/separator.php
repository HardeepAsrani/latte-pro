				...
				<div class="row">
					...
					<?php if(!empty($latte_separator_button)) : ?>
						<?php if(!empty($latte_separator_link)) : ?>
							<a data-sr="enter bottom wait 0.25s" class="btn btn-lg btn-success" href="<?php echo esc_url($latte_separator_link); ?>"><?php echo esc_html($latte_separator_button); ?></a>
						<?php else: ?>
							<span data-sr="enter bottom wait 0.25s" class="btn btn-lg btn-success" ><?php echo esc_html($latte_separator_button); ?></span>
						<?php endif; ?>
					<?php endif; ?>
					</div>
				</div>
